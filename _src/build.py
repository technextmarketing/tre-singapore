...
PAGES = [
    ...
    ("online-session-guide.body.html", "online-session-guide.html", "Setting up for your online TRE® session — TRE® in Singapore",
     "How to set up your space, camera, kit and Zoom before an online TRE® session: head-to-toe framing, checklist, support person and the fifteen-minutes-before routine.", "events"),
